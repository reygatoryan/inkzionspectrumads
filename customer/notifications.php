...
function renderNotifications(notifs) {
  ...
  if (!container) return;
  if (notifs.length === 0) {
    container.innerHTML = '<div class="empty-state"><div style="font-size:2.5rem;color:rgba(233,30,142,0.15);margin-bottom:0.75rem;"><i class="fas fa-bell"></i></div><p style="color:#64748b;">No notifications yet.</p></div>';
    return;
  }
