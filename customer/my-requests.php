...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .req-card:hover { border-color: rgba(233,30,142,0.2); box-shadow: 0 4px 16px rgba(0,0,0,0.06); }
    ...
    .empty-state i { font-size: 3.5rem; color: rgba(233,30,142,0.15); margin-bottom: 1rem; }
