...
if (!$req) { echo '<html><body style="font-family:sans-serif;padding:3rem;text-align:center;color:#64748b;"><h2>Request not found</h2><p>This request does not exist or you do not have access.</p><a href="my-requests.php" style="color:#e91e8c;">Back to My Requests</a></body></html>'; $conn->close(); exit(); }
...
$statusLabels = [
    ...
    'ready_for_purchase' => ['Ready to Buy', '#be1871', 'rgba(233,30,142,0.12)'],
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-primary { background: linear-gradient(135deg, var(--primary), var(--primary-light)); color: white; box-shadow: 0 4px 12px rgba(233,30,142,0.25); }
