...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .modal-box.tracking { max-width: 900px; height: calc(100vh - 3rem); display: flex; flex-direction: column; padding: 0; }
      ...
      <div id="orders-list">
        ...
        <?php else: ?>
          <?php foreach ($groupedOrders as $order):
            $tabCategory = 'all';
            switch ($order['status']) {
              case 'pending': $tabCategory = 'pending'; break;
              case 'confirmed': $tabCategory = 'production'; break;
...
<div class="modal-overlay" id="trackingModal" onclick="if(event.target===this)closeTrackingModal()">
  <div class="modal-box tracking">
    <div class="modal-header" style="position:sticky;top:0;background:white;display:flex;align-items:center;justify-content:space-between;padding:1.5rem 1.5rem 1rem;border-bottom:1px solid #f1f5f9;flex-wrap:wrap;gap:0.5rem;">
      <h2 style="font-size:1.2rem;font-weight:700;color:#0f172a;display:flex;align-items:center;gap:0.5rem;min-width:0;"><i class="fas fa-truck"></i> Order Tracking</h2>
